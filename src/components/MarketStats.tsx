...
import { fetchGlobalMarketData } from "@/services/marketDataService";

const fetchMarketStats = async () => fetchGlobalMarketData();
...
const MarketStats = () => {
  ...
  const stats = [
    {
      title: "Market Cap",
      value: data?.total_market_cap || 0,
      change: data?.market_cap_change_percentage_24h || 0,
      icon: DollarSign,
      format: "currency"
    },
    {
